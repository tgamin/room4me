...
class ReservationPaidNotification extends Notification
{
    ...
    public function __construct($reservation, $translations)
    {
        ...
        $this->subject = $translations['reservation']['paid']['mail']['subject'][$this->lang];
        $this->buttonText = $translations['reservation']['paid']['mail']['button'][$this->lang];
        $this->body = $translations['reservation']['paid']['mail']['body'][$this->lang];
        ...
        $template = $translations['reservation']['paid']['sms']['message'][$this->lang];
    ...
    {
        $link = route('reservation.pay', $this->reservation->confCode);
